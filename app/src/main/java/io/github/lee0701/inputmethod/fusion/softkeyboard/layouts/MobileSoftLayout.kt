...
object MobileSoftLayout {
    ...
    val LAYOUT_12KEY_4COLS = Layout(listOf(Row(listOf(
            ...
            Key(0x200c, "#"),
            Key(66, "RET")
    ), Row.Type.EVEN)), keyWidth = 0.25f, key = "12key-4cols")
    ...
    val LAYOUT_15KEY_A = Layout(listOf(Row(listOf(
            ...
            Key(59, "SFT"),
            Key(66, "RET")
    ), Row.Type.EVEN)), keyWidth = 0.20f, key = "15key-a")
    ...
    val LAYOUT_15KEY_B = Layout(listOf(Row(listOf(
            ...
            Key(56, "."),
            Key(66, "RET")
    ), Row.Type.EVEN)), keyWidth = 0.20f, key = "15key-b")
    ...
    val LAYOUT_15KEY_A_WITH_NUM = Layout(listOf(Row(listOf(
            ...
            Key(59, "SFT"),
            Key(66, "RET")
    ), Row.Type.EVEN)), keyWidth = 0.20f, key = "15key-a-with-num")
    ...
    val LAYOUT_15KEY_B_WITH_NUM = Layout(listOf(Row(listOf(
            ...
            Key(56, "."),
            Key(66, "RET")
    ), Row.Type.EVEN)), keyWidth = 0.20f, key = "15key-b-with-num")
