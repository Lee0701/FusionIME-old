...
object SoftLayout {
    ...
    ), Row.Type.BOTTOM)), key = "10cols-mobile")
    ...
    val LAYOUT_10COLS_MOBILE_WITH_NUM = Layout(listOf(Row(listOf(
            ...
            Key(keyCode = 56, label = ".", keyWidth = 1/10f),
            Key(keyCode = 66, label = "RETURN", keyWidth = 0.15f)
    ), Row.Type.BOTTOM)), key = "10cols-mobile-with-num")

    val LAYOUT_10COLS_MOBILE_WITH_APOSTROPHE = Layout(listOf(Row(listOf(
            Key(45, "q"),
            Key(51, "w"),
            Key(33, "e"),
            Key(46, "r"),
            ...
            Key(keyCode = 56, label = ".", keyWidth = 1/10f),
            Key(keyCode = 66, label = "RETURN", keyWidth = 0.15f)
    ), Row.Type.BOTTOM)), key = "10cols-mobile-with-apostrophe")

    val LAYOUT_10COLS_MOBILE_WITH_APOSTROPHE_NUM = Layout(listOf(Row(listOf(
            Key(8, "1"),
            Key(9, "2"),
            Key(10, "3"),
            Key(11, "4"),
            ...
            Key(keyCode = 56, label = ".", keyWidth = 1/10f),
            Key(keyCode = 66, label = "RETURN", keyWidth = 0.15f)
    ), Row.Type.BOTTOM)), key = "10cols-mobile-with-apostrophe-num")
    ...
    val LAYOUT_10COLS_DVORAK = Layout(listOf(Row(listOf(
            ...
            Key(keyCode = 66, label = "RETURN", keyWidth = 0.15f)
    ), Row.Type.BOTTOM)), key = "10cols-dvorak")
    ...
    val LAYOUT_10COLS_DVORAK_WITH_NUM = Layout(listOf(Row(listOf(
            ...
            Key(keyCode = 76, label = "/", keyWidth = 0.1f),
            Key(keyCode = 66, label = "RETURN", keyWidth = 0.15f)
    ), Row.Type.BOTTOM)), key = "10cols-dvorak-with-num")
    ...
    val LAYOUT_10COLS_MOD_QUOTE = Layout(listOf(Row(listOf(
            ...
            Key(keyCode = 76, label = "/", keyWidth = 0.1f),
            Key(keyCode = 66, label = "RETURN", keyWidth = 0.15f)
    ), Row.Type.BOTTOM)), key = "10cols-mod-quote")
    ...
    val LAYOUT_10COLS_MOD_QUOTE_WITH_NUM = Layout(listOf(Row(listOf(
            ...
            Key(keyCode = 76, label = "/", keyWidth = 0.1f),
            Key(keyCode = 66, label = "RETURN", keyWidth = 0.15f)
    ), Row.Type.BOTTOM)), key = "10cols-mod-quote-with-num")
