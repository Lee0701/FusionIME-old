...
object TabletSoftLayout {
    ...
    val LAYOUT_11COLS_TABLET = Layout(listOf(Row(listOf(
            ...
            Key(keyCode = 63, label = "?12", keyWidth = 2/11f)
    ), Row.Type.BOTTOM)), keyWidth = 1/11f, key = "11cols-tablet")
    ...
    val LAYOUT_11COLS_TABLET_WITH_NUM = Layout(listOf(Row(listOf(
            ...
            Key(keyCode = 76, label = "/", keyWidth = 1/11f),
            Key(keyCode = 63, label = "?12", keyWidth = 2/11f)
    ), Row.Type.BOTTOM)), keyWidth = 1/11f, key = "11cols-tablet-with-num")
    ...
    ), Row.Type.BOTTOM)), keyWidth = 1/11f, key = "11cols-tablet-with-quote")
    ...
    val LAYOUT_11COLS_TABLET_WITH_QUOTE_NUM = Layout(listOf(Row(listOf(
            ...
            Key(keyCode = 76, label = "/", keyWidth = 1/11f),
            Key(66, "RETURN", keyWidth = 2/11f)
    ), Row.Type.BOTTOM)), keyWidth = 1/11f, key = "11cols-tablet-with-quote-num")
